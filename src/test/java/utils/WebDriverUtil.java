...
public class WebDriverUtil {
    ...
    private static WebDriverUtil webDriver = null;
    //--------------------自定义常量------------------------
...
//    }
     ...
     * @see ExpectedConditions 去查看方法textToBePresentInElement(WebElement element, String text)
     *
     */
     ...
     * @see ExpectedConditions //去查看方法visibilityOfElementLocated(By locator)
     */
     ...
     * @param locator
     * @param text
     * @see Select //selectByVisibleText(String text)
     */
     ...
     * @see Select //selectByValue(String value)
     */
    ...
    /**
     *     切换至父级frame
     * @see WebDriver.TargetLocator //parentFrame()
     */
     ...
     * @param driver
     */
    public static void screenShot(WebDriver driver,String behavior) {
        ...
        try {
            ...
            if (StringUtils.isNotBlank(behavior)) {
                FileUtils.copyFile(source_file, new File(dir_name + File.separator + time+"-" +behavior+ ".png"));
            }else {
    ...
    public static void screenShot(WebDriver driver,String behavior,String testClassName) {
        ...
        try {
            File source_file = (((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE));// 执行截屏
            if (StringUtils.isNotBlank(behavior) && StringUtils.isNotBlank(testClassName)) {
                FileUtils.copyFile(source_file, new File(dir_name + File.separator + time + "-" + testClassName + "-" + behavior + ".png"));
            }else {
                FileUtils.copyFile(source_file, new File(dir_name + File.separator + time + ".png"));
            }
        } catch (IOException e) {
     ...
     * @param name
     * @param value
     * @see WebDriver.Options//.addCookie(Cookie cookie)
     * @see Cookie//.Cookie(String name, String value)
     */
     ...
     * @see WebDriver.Options//.deleteCookieNamed(String name)
     */
     ...
     *         </ul>
     * @see WebDriver.Options//.getCookieNamed(String name)
     */
